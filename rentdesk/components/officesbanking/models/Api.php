...
function procesarLiquidacion($ficha_tecnica_propiedad, $NumeroCierre, $services, $url_services, $QueryBuilder)
{
    ...
    try {
        ...
        // obtiene el numero de cierre
        $NroCierre = $NumeroCierre;
...
if (is_array($id)) {
    ...
    foreach ($id as $ficha_tecnica) {
        $archivoGenerado = procesarLiquidacion($ficha_tecnica, $NumeroCierre, $services, $url_services, $QueryBuilder);
    ...
    $archivoGenerado = procesarLiquidacion($id, $NumeroCierre, $services, $url_services, $QueryBuilder);
